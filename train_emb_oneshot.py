...
# /////////////////////////////////////////////////////////////////////////////
    ...
    dir = "oneshot_lightgcn_lot/ckpt/emb/"
    ...
    #from baseline
    weight = [(1 - (1 - args.pruning_percent_wei) ** (i)) for i in range(1, 31, 1)]
    for i in range(2, 31, 1):
        args.pruning_percent_wei = weight[i]
        if args.dataset == "yelp2018":
            model = torch.load("./lightgcnlot/ckpt/emb/part-join-reg-0.0001-loss-bpr-stop-100-epoch-1000-nonstop-dim-32-per-0.1-imp-1")
